...
//
//        log.info(request.getHeader("file-name"));
//        log.info(request.getHeader("file-size"));
//        log.info(request.getHeader("file-Type"));
//
//        String filename = request.getHeader("file-name");
//
//        String realFileNm = ImageUtil.UPLOAD_BASE_PATH + File.separator + filename;
//
//        try {
//            InputStream is = request.getInputStream();
//
...
//        sFileInfo += "&sFileName=" + filename;
//        sFileInfo += "&sFileURL=/shop/upload/"+ filename;
